    ...
    def run(self):
        ...
        for i in range(int(total_time/delta_t)):
            ...
            if (i > 0) and (i % switch_index == 0):
                ...
                if step_num >= 10: # stop forward after 5 steps
                    s_x = 0.0
                ...
                if LIPM_model.support_leg == 'left_leg':
                    ...
                    swing_foot_pos[1:swing_data_len-1, 2] = 0.2
                    swing_foot_pos[1:10, 2] = np.linspace(0, 0.20, 9)
                    swing_foot_pos[swing_data_len-10:swing_data_len-1, 2] = np.linspace(0.20,0, 9)
        ...
        for i in range(1500):
            self.COM_pos_z.append(COM_pos_0[2])
def test1():
    swing_data_len = 25
    swing_foot_pos = np.zeros((swing_data_len, 3))
    swing_foot_pos[1:swing_data_len-1, 2] = 0.20
